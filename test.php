<?php
$login = 'info@hpractic.com'; // замените test@example.com на адрес электронной почты, с которого производится отправка (поскольку логин совпадает с адресом отправителя - данная переменная используется и как логин, и как адрес отправителя)
$password = '3Yda!^79s~GF'; // замените password на пароль от почтового ящика, с которого производится отправка
$to = 'djalximik@gmail.com'; // замените to@example.com на адрес электронной почты получателя письма
