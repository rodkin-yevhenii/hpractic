...
if (500 === $error) {
    ...
    $text = __(
        'Произошла ошибка сервера при формировании страницы.<br>Пожалуйста, сообщите нашему менеджеру.<br>
    ...
    <div class="container">
        <div class="section__message">
            ...
            <div class="section__message-footer">
                ...
                <ul>
                    <li>
                        <?php printf(__('Перейти на <a href="%s">главную страницу</a>', 'hpractice'), home_url()); ?>
                    </li>
                    <li>
                        <?php printf(
                            __('Познакомиться с <a href="%s">нашей продукцией</a>', 'hpractice'),
