...
<div id="popup-success" class="popup mfp-with-anim mfp-hide">
    <div class="popup__inner">
        <div class="popup__content ">
            ...
            <p>
                <?php _e(
                    'В ближайшее время с вами свяжется наш менеджер для уточнения деталей заказа. <br>Заказы,
оформленные через корзину сайта в выходные и праздничные дни, будут по очереди обработаны в первый рабочий день.',
                    'hpractice'
                ); ?>
            </p>
            ...
            <?php endif; ?>
            <p><?php _e('Ожидайте нашего звонка', 'hpractice'); ?></p>
