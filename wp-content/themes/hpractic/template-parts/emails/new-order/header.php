    ...
    <div class="block-grid three-up"
        ...
        <div style="border-collapse: collapse;display: table;width: 100%;background-color:#f2f5f8;">
            ...
            <td align="center" width="175"
                style="background-color:#f2f5f8;width:175px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;"
                valign="top">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
            ...
            <![endif]-->
            <div class="col num3"
                 style="display: table-cell; vertical-align: top; max-width: 320px; min-width: 174px; width: 175px;">
                                    ...
                                    <td style="padding-right: 0px;padding-left: 0px;" align="left">
                                        ...
                                        <a href="<?php echo site_url(); ?>" style="outline:none" tabindex="-1" target="_blank">
                                            <img
                                                ...
                                                src="<?php
                                                echo site_url('wp-content/themes/hpractic/frontend/src/img/logo-practice-house.png'); ?>"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="divider"
                            ...
                            <tr style="vertical-align: top;" valign="top">
                                <td class="divider_inner"
                                    style="word-break: break-word; vertical-align: top; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding-top: 10px; padding-right: 10px; padding-bottom: 0px; padding-left: 10px;"
                                    valign="top">
            ...
            <td align="center" width="350"
                style="background-color:#f2f5f8;width:350px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;"
                valign="top">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
            ...
            <div class="col num6"
                ...
                <div class="col_cont" style="width:100% !important;">
                    ...
                    <div
                        ...
                        <![endif]-->
                        <div
                            style="color:#30609a;font-family:Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif;line-height:1.2;padding-top:15px;padding-right:10px;padding-bottom:15px;padding-left:10px;">
                            <div class="txtTinyMce-wrapper"
                                 style="line-height: 1.2; font-size: 12px; color: #30609a; font-family: Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 14px;">
                                <p style="margin: 0; font-size: 16px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 19px; margin-top: 0; margin-bottom: 0;">
                                    <span style="font-size: 16px;">
                                        <a href="https://www.hpractic.com/"
                                           rel="noopener"
                                           style="text-decoration: none; color: #30609a;"
                                           target="_blank"
                                        >
                                            <?php
                                            _e('Главная', 'hpractice'); ?>
                                        </a>       
                                        <a
                                            href="<?php
                                            echo get_permalink(Helpers::getCatalogId()); ?>"
                                            rel="noopener"
                                            style="text-decoration: none; color: #30609a;"
                                            target="_blank"
                                        >
                                            <?php
                                            _e('Продукция', 'hpractice'); ?>
                                        </a>        
                                        <a
                                            href="<?php
                                            echo get_permalink(Helpers::getServicePageId()); ?>"
                                            rel="noopener"
                                            style="text-decoration: none; color: #30609a;"
                                            target="_blank"
                                        >
